...
export class OpenTrackFitChangelogComponent implements OnInit {
  ...
  history = [
    ...
    {version: "1.1.13", notes: "Fixed issue with workout list not saving on increment/de-increments, and timer finishing a task.<br/><br/>- Fixed flashing when defaulting to dark mode."},
  ]
